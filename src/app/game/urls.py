...
urlpatterns = patterns('',
    ...
    url(r'^stick/(?P<id>.+)/$', game_views.game_stick, name='game_stick'),
)
...
urlpatterns += patterns('',
    ...
    url(r'^tag/delete/(?P<id>.+)/$', tag_views.delete, name='game_tag_delete'),
)
...
urlpatterns += patterns('',
    ...
    url(r'^category/delete/(?P<id>.+)/$', category_views.delete, name='game_category_delete'),
)
